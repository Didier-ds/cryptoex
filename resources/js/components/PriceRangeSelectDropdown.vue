      ...
      <div class="relative mt-1">
        ...
        >
          <span class="flex uppercase font-semibold items-center work truncate ">
              <template v-if="selectedPriceRange != null">{{allPriceRanges[selectedPriceRange].min}} - {{allPriceRanges[selectedPriceRange].max}}</template>
        ...
        >
          ...
          >
            <ListboxOption
              ...
              v-for="(priceRange, index) in allPriceRanges"
              :key="priceRange.type"
              :value="index"
              as="template"
            >

        ...
        <max-width-container>
            ...
            <div class="main_container">
                ...
                <div id="form_container">
                    <div class="my-4">
                        <p class="font-bold text-gray-800 work text-lg">Log In to Your Account</p>
                    </div>
                    ...
                    <form @submit.prevent="submit">
                        ...
                        <div class="mb-4">
                            <q-btn color="primary" type="submit" unelevated  class="w-full primary_shadow py-3 work font-medium" label="Login"/>
                        </div>
                    </form>
                    <div class="other_link_section flex flex-col">
                        <inertia-link to="/forgotpassword" class="forgot-password self-end inline-block mb-4 font-semibold text-cyan">Forgot Your Password</inertia-link>

                ...
                <section class="max-w-xl w-full mx-auto p-4">
                    ...
                    <template v-else>
                        ...
                        <template v-if="step === 2">
                            ...
                            <div :data-active="isDropzoneActive" @drop.prevent="dropZoneFiles" @dragenter.prevent="setActive" @dragover.prevent="setActive" @dragleave.prevent="setInactive"  class="border-dashed my-4 px-4 py-4 rounded bg-white flex flex-col text-center justify-between items-center border-2">
